...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes):
        ...
        # Classifier
        self.classifier1 = nn.Conv2d(256+32, num_classes, kernel_size=1)
        self.classifier2 = nn.Conv2d(512+32, num_classes, kernel_size=1)

        self.branch_sn = nn.BatchNorm2d(3)
        self.branch_relu = nn.ReLU()   
        self.brancn_sn1 = nn.BatchNorm2d(3)
        self.branch_relu1 = nn.ReLU()
        self.can=nn.Conv2d(9,32,3,stride=2,padding=1)
...
def FaceParseNet18(num_classes=19, pretrained=True):
...
def FaceParseNet34(num_classes=19, pretrained=True):
...
if __name__ == '__main__':
    ...
    net = FaceParseNet34(pretrained=True)
    stat(net, (3, 256, 256))
