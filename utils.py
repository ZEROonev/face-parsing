...
def vis_parsing_maps(im, parsing_anno, color=[230, 50, 20]):
    ...
    vis_parsing_anno_color = np.zeros((parsing_anno.shape[0], parsing_anno.shape[1], 3))
    ...
    vis_im = cv.addWeighted(cv.cvtColor(vis_im, cv.COLOR_RGB2BGR), 1.0, vis_parsing_anno_color, 0.5, 0)
